...
static constexpr unsigned int DEFAULT_BLOCK_MIN_TX_FEE{300};
...
static constexpr unsigned int DEFAULT_INCREMENTAL_RELAY_FEE{300};
...
static constexpr unsigned int DUST_RELAY_TX_FEE{500};
/** Default for -minrelaytxfee, minimum relay fee for transactions */
static constexpr unsigned int DEFAULT_MIN_RELAY_TX_FEE{300};
