...
public:
    CMainParams() {
        ...
        consensus.nSubsidyHalvingInterval = 1051200; // ~4 years
        ...
        genesis = CreateGenesisBlock(1716240000, 1988506751, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256{"000000001783ba7a626f9add1340774daae74a64f1b2dd0c7cc5c829f562b25e"});
        assert(genesis.hashMerkleRoot == uint256{"c5133d9f2f9d7bda392762cc0c1914bcdaa6f62adb9eb088f40d91b3c61983bb"});
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,58); // 'Q' = 0x3A for Quanta
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,50);
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x4F};  // Quanta qpub
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0x56};  // Quanta qprv
