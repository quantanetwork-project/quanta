...
{
    const char* pszTimestamp = "The Times 03/May/2025 A new chain begins";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 3.5 * 24 * 60 * 60; // Three and Half Days
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nTimeout = 9999999999; // August 11th, 2021
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].min_activation_height = 709632; // Approximately November 12th, 2021

        consensus.nMinimumChainWork = uint256{};
        consensus.defaultAssumeValid = uint256{}; // 856760
        ...
        genesis = CreateGenesisBlock(1746522270, 2759715749, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256{"000000006e45bda626842e05b135ed1bc375b72c3e97bbed1dfd14f54a066916"});
        assert(genesis.hashMerkleRoot == uint256{"1b8c761b75c673fbb5c33994f2eed1eeefa4ae2846afdec7494b192c7b2351ae"});
        ...
        checkpointData = {
            {
                {0, uint256("000000006e45bda626842e05b135ed1bc375b72c3e97bbed1dfd14f54a066916")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1746534542, 1761463993, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256{"0000000042cfb8796d1d6565fdbfc3cbdfc9cdb10f76c1888a205ccf7d404b35"});
        assert(genesis.hashMerkleRoot == uint256{"1b8c761b75c673fbb5c33994f2eed1eeefa4ae2846afdec7494b192c7b2351ae"});
...
public:
    CTestNet4Params() {
        ...
        const char* testnet4_genesis_msg = "The Times 03/May/2025 A new chain begins";
        ...
        genesis = CreateGenesisBlock(testnet4_genesis_msg,
                ...
                50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0000000071a6ff5a8fb8b66d2b4c402f3fcd129721c31a1a51f33bb0c0cc1d66"));
        assert(genesis.hashMerkleRoot == uint256S("1b8c761b75c673fbb5c33994f2eed1eeefa4ae2846afdec7494b192c7b2351ae"));
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        genesis = CreateGenesisBlock(1746539085, 15162, 0x1e0377ae, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256{"00000154ac775696a0997ef736c6b8d5464c6d4c56eecabf01172c436a8b9637"});
        assert(genesis.hashMerkleRoot == uint256{"1b8c761b75c673fbb5c33994f2eed1eeefa4ae2846afdec7494b192c7b2351ae"});
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        genesis = CreateGenesisBlock(1746539522, 2, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256{"2e10784766f6fc09b19a9921d7f4b1024d1331d0c2d82ca7ea8251e6161d0d4d"});
        assert(genesis.hashMerkleRoot == uint256{"1b8c761b75c673fbb5c33994f2eed1eeefa4ae2846afdec7494b192c7b2351ae"});
        ...
        checkpointData = {
            {
                {0, uint256{"2e10784766f6fc09b19a9921d7f4b1024d1331d0c2d82ca7ea8251e6161d0d4d"}},
            }
        };
