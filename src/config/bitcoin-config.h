...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Quanta Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Quanta Core"
...
#define PACKAGE_NAME "Quanta Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Quanta Core 1.0.0"
